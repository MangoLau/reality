...
{
    public $Priority = 3;
    public $CharSet = 'iso-8859-1';        //该消息的字符集
    public $ContentType = 'text/plain';     //消息的MIME内容类型
    public $Encoding = '8bit';          //该消息编码
    public $ErrorInfo = '';             //最新的邮件错误消息。
    public $From = 'root@localhost';    //邮件发件人的电子邮件地址。
    public $FromName = 'Root User';     //邮件发件人名称
    public $Sender = '';                //邮件发件人的电子邮件（返回路径）
    public $Subject = '';               //邮件主题
    public $Body = '';                  //HTML或纯文本邮件正文。
    public $AltBody = '';               //纯文本邮件正文。
    public $WordWrap = 0;
    public $Mailer = 'mail';
