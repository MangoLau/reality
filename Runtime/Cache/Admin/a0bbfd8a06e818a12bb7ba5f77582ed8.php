            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form action="<?php echo U('altLink');?>" method="post" class="form-horizontal"  enctype="multipart/form-data">
                            <div class="control-group">
                                <label class="control-label">链接名：</label>
                                <div class="controls">
                                    <input type="text" name="link_name" value="<?php echo ($list['link_name']); ?>" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="href" value="<?php echo ($list['href']); ?>" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="type">
                                        <?php if($list['type'] == 1): ?><option value="1" selected="selected">友情链接
                                            <option value="0">其他链接
                                        <?php else: ?>
                                            <option value="1">友情链接
                                            <option value="0" selected="selected">其他链接<?php endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">修改图标</label>
                                <div class="controls">
                                    <input type="file" id="exampleInputFile" name="img">
                                    <p class="help-block">建议图标大小为：50*50px
                                        <?php if($list['img'] != ''): ?><img src="/reality<?php echo ($list['img']); ?>" style="width: 50px;"><?php endif; ?>
                                    </p>
                                </div>
                            </div>
